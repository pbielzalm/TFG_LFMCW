function [detections_to_track, trazas, trazas_muertas, historial, promoEstablecida, conjuntoCovarianzas] = mahalanobis_NCV(interpoledPlot, trazasFiltradas, conjuntoCovarianzas, trazas, historial, nburst, config, delta, P_ini, senal)
...
% Convertimos las velocidades del kalman ambiguas en no ambiguas
...
dthMah=1000.6^2; %Dos dimensiones: (nz=2) --> Pg=0.995-> dth=10.6
noMah = 30;%Distancia para las vuelta_umbral primeras vueltas  %%%%%% Con 18 funciona para 350 y 200
...
%         disp('vuelta de paneo');
    for k=1:longTrazas
        ...
        % distancia
            ...
            Y = [interpoledPlot.r(i); interpoledPlot.v(i)];
            X =cell2mat(trazasFiltradas(k));
